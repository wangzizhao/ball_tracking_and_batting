...
#ifndef _camera_coord_t_h
#define _camera_coord_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _camera_coord_t camera_coord_t;
struct _camera_coord_t
{
    double     x;
    double     y;
    double     z;
...
/**
 * Create a deep copy of a camera_coord_t.
 * When no longer needed, destroy it with camera_coord_t_destroy()
 */
camera_coord_t* camera_coord_t_copy(const camera_coord_t* to_copy);

/**
 * Destroy an instance of camera_coord_t created by camera_coord_t_copy()
 */
void camera_coord_t_destroy(camera_coord_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _camera_coord_t_subscription_t camera_coord_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * camera_coord_t is received.
 */
typedef void(*camera_coord_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const camera_coord_t *msg, void *userdata);

/**
 * Publish a message of type camera_coord_t using LCM.
 *
 ...
 */
int camera_coord_t_publish(lcm_t *lcm, const char *channel, const camera_coord_t *msg);

/**
 * Subscribe to messages of type camera_coord_t using LCM.
 *
 ...
 */
camera_coord_t_subscription_t* camera_coord_t_subscribe(lcm_t *lcm, const char *channel, camera_coord_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by camera_coord_t_subscribe()
 */
...
/**
 * Encode a message of type camera_coord_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to camera_coord_t_encoded_size().
...
/**
 * Decode a message of type camera_coord_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with camera_coord_t_decode_cleanup().
 *
 ...
 */
int camera_coord_t_decode(const void *buf, int offset, int maxlen, camera_coord_t *msg);

/**
 * Release resources allocated by camera_coord_t_decode()
 * @return 0
 */
int camera_coord_t_decode_cleanup(camera_coord_t *p);

/**
 * Check how many bytes are required to encode a message of type camera_coord_t
 */
